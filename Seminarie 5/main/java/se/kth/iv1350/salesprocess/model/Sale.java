...
public class Sale {
    ...
    /**
     * Notifies the observer when the sale has been finnished.
     */
    public void finnishSale(){
        notifyOberservers();
    }
    /**
    ...
    /** 
     * The specified observer that will be called when the sale has been payed.
     * @param saleObserver 
     */
   ...
   /**
    * Notifies the observer with the variabel that is to be presented
    */
   public void notifyOberservers(){
       saleObserver.newPayment(runningTotal);
